#
# Define: cinder::backend::synology
#
# === Parameters:
#
# [*iscsi_ip_address*]
...
#   Defaults to 'cinder.volume.drivers.synology.synology_iscsi.SynoISCSIDriver'
#
# [*volume_group*]
...
#
# [*synology_admin_port*]
#   (Optional) Management port for Synology storage.
#   Defaults to '5000'.
#
# [*synolgy_username*]
#   (Optional) Administrator of Synology storage.
#   Defaults to 'admin'
#
# [*synology_password*]
#   (Required) Password of administrator for logging in Synology storage.
#
# [*synology_pool_name*]
...
define cinder::backend::synology (
  ...
  cinder_config {
    ...
    "${name}/synology_admin_port":  value => $synology_admin_port;
